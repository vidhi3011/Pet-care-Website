...
<body>
                            ...
                            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item active">
                                        <a href="login.html" class= " nav-link active">Signin</a>
                                    </li>
    ...
    <div class="sub_header_social_icon float-center">
        <h1 align="center"><u><b>Welcome to Paw Pal</u></b></h1>
      ...
      <div class="frame">
        <div class="nav">
          <ul class="links">
            ...
            <li class="signup-inactive"><a href="register.html" class="btn">Sign up </a></li>
          </ul>
        </div>
        <div ng-app ng-init="checked = false">
              ...
              <div class="btn-animate">
                <a class="btn-signin" name="login" value="Login">Sign in</a>
              </div>
     ...
     <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="login.php" method="post" class="p-sm-3">
                    ...
                    <div class="right-w3l">
                        <input type="submit" name="btn_login" class="form-control button" value="Login">
                    </div>
                    ...
                    <p class="text-center dont-do modal-footer1">Don't have an account?
                        <a href="register.html" data-toggle="modal" data-target="#exampleModal1" class="font-weight-bold" data-blast="color">
                            Register Now</a>
                        </section>
                    </p>
                </form>
